...
1. Using the AWS account registered as your [AWS Marketplace Seller account](https://docs.aws.amazon.com/marketplace/latest/userguide/seller-registration-process.html), open [AWS CloudShell](https://eu-west-1.console.aws.amazon.com/cloudshell). 
...
6. Follow the SAM guided experience to configure the deployment. Reference the following table for solution parameters.
    ...
    AWS Region | Name of the region that the solution is being deployed in. Default value: eu-west-1
