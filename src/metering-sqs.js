...
// MarketplaceMetering is instantianize in eu-west-1 as all SaaS product listing ARN is stored in eu-west-1.
const marketplacemetering = new AWS.MarketplaceMetering({ apiVersion: '2016-01-14', region: 'eu-west-1' });
